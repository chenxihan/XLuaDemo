	...
	public UIFont replacement
	{
		...
		set
		{
			...
			if (mReplacement != rep)
			{
                ...
                //根据实际的使用情况,当前字体被修改了,不需要重新修改字体mReplacement. 2015.12.16 -- by gzg
