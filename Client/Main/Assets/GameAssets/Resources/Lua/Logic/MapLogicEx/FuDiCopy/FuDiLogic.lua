...
function FuDiLogic:OnEnterScene(parent)
    self.Parent = parent
...
function FuDiLogic:OnLeaveScene()
    --打开小地图功能
...
--处理协议
function FuDiLogic:OnMsgHandle(msg)
...
function FuDiLogic:GetMainUIState()
    return {
...
function FuDiLogic:GetMainLeftUIState()
    return {
