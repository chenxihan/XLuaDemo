...
function FuDiDuoBaoLogic:OnEnterScene(parent)
    self.Parent = parent
    ...
    --关掉副本主界面
    GameCenter.PushFixEvent(UIEventDefine.UIFuDiDuoBaoForm_Close)
    --打开福地夺宝副本UI
    GameCenter.PushFixEvent(UIEventDefine.UIFuDiDuoBaoCopy_Open)
...
function FuDiDuoBaoLogic:OnLeaveScene()
    --打开小地图功能
    GameCenter.MainFunctionSystem:SetFunctionVisible(FunctionStartIdCode.AreaMap, true)
    --关闭夺宝副本UI
    GameCenter.PushFixEvent(UIEventDefine.UIFuDiDuoBaoCopy_Close)
end

--更新
function FuDiDuoBaoLogic:Update(dt)
...
--处理协议
function FuDiDuoBaoLogic:OnMsgHandle(msg)
...
function FuDiDuoBaoLogic:GetMainUIState()
    return {
...
function FuDiDuoBaoLogic:GetMainLeftUIState()
    return {
